...
Executing the file main.py will run the numerical experiments presented in the paper "A. Oustry, C. D'Ambrosio, L. Liberti, M. Ruiz, The dual ACOPF as a sparse and unconstrained nonsmooth optimization problem" (submitted, under review). 
